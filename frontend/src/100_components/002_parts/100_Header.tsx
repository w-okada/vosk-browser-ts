    ...
    return (
        <div className="header">
            <div className="header-application-title-container">
                ...
                <div className="header-application-title-text">Offline Transcribe</div>
            </div>

            <div className="header-button-container">
                <a className="header-button-link" href="https://github.com/w-okada/vosk-browser-ts" target="_blank" rel="noopener noreferrer">
